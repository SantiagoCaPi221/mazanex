...
public class AuthService {
    ...
    public User registerUser(User user) {
        ...
        try {
            ...
            // No impedir el registro si ms-profile no está disponible
        }
    ...
    public void syncWithProfile(User user) {
        ...
        // En los tests con Mockito @Value no se inyecta
    ...
    public Map<String, Object> login(UserRequestDto userDto) {
        ...
        if (optUser.isPresent()
                && optUser.get().getPassword().equals(userDto.password())) {
        ...
        return userRepository.findById(id)
                .map(u -> {
                    ...
                    if (data.getBannerUrl() != null)
                        u.setBannerUrl(data.getBannerUrl());

                    if (data.getBio() != null)
                        u.setBio(data.getBio());

                    if (data.getBackgroundUrl() != null)
                        u.setBackgroundUrl(data.getBackgroundUrl());
